...
# from gpt_attention_rope_kv_cache_practice import GPTLanguageModel, decode
from gpt_attention_rope_practice import GPTLanguageModel, decode
...
checkpoint = torch.load(model_save_path, map_location=torch.device("cpu"))  # Map to CPU
